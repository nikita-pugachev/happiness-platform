...
## О проекте
Интернет-магазин счастья - это веб-приложение, где пользователь за улыбки может приобрести что-то, что делает его счастливым. Это не материальные вещи, не деньги, это то, что греет душу. Все должны улыбаться и быть счастливы. Приложение разработано только с целью закрепления навыков работы с новыми технологиями.

## Планы по развитию
- Проработать SEO.
- Изменить базу данных товаров, добавить рейтинг для товаров.
